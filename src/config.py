...
class Settings:
    ...
    MODEL_NAME: str = os.getenv("MODEL_NAME", "qwen-math-1.5b")
    MODEL_FILE: str = os.getenv("MODEL_FILE", "Qwen2.5-Math-1.5B-Instruct-Q4_K_M.gguf")
    MODEL_PATH: str = os.getenv(
        "MODEL_PATH",
        str(Path(__file__).resolve().parent.parent / "models" / os.getenv("MODEL_FILE", "Qwen2.5-Math-1.5B-Instruct-Q4_K_M.gguf")),
    )
    MODEL_URL: str = os.getenv("MODEL_URL", "https://huggingface.co/bartowski/Qwen2.5-Math-1.5B-Instruct-GGUF/resolve/main/Qwen2.5-Math-1.5B-Instruct-Q4_K_M.gguf")
